...
- Copy script's Github URL and paste into SND2 GitHub URL option to import and update.  ie.:
  - `https://github.com/reddywhp/SND-Scripts/blob/main/FATEs/Fate%20Farming.lua`
### or
...
Load in your scripts, and then configure them.  Note, you can choose to just run [Fate Farming.lua](https://github.com/reddywhp/SND-Scripts/blob/main/FATEs/Fate%20Farming.lua).  It will automatically farm the zone you're currently in until you manually stop it.  If you want to run with a purpose, then use [Multi Zone Farming.lua](https://github.com/reddywhp/SND-Scripts/blob/main/FATEs/Multi%20Zone%20Farming.lua) or [Relic Fodder.lua](https://github.com/reddywhp/SND-Scripts/blob/main/FATEs/Relic%20Fodder.lua), which will Zone-jump as needed to meet your goals.
### Load your scripts
...
1. Add Fate Farming.lua
  ...
  2. **Name**: Fate Farming
  3. **Type**: Lua
  4. **GitHub URL**: copy in the URL for [Fate Farming.lua](https://github.com/reddywhp/SND-Scripts/blob/main/FATEs/Fate%20Farming.lua)
2. Add Multi Zone Farming.lua (optional)
  1. Click "Creat a new macro"
  2. **Name**: Multi Zone Farming
  3. **Type**: Lua
  4. **GitHub URL**: copy in the URL for [Multi Zone Farming.lua](https://github.com/reddywhp/SND-Scripts/blob/main/FATEs/Multi%20Zone%20Farming.lua)
3. Add Relic Fodder.lua (optional)
  1. Click "Creat a new macro"
  2. **Name**: Relic Fodder
  3. **Type**: Lua
  4. **GitHub URL**: copy in the URL for [Relic Fodder.lua](https://github.com/reddywhp/SND-Scripts/blob/main/FATEs/Relic%20Fodder.lua)
